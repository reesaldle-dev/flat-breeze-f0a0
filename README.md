...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/flat-breeze-f0a0)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/flat-breeze-f0a0
```

A live public deployment of this template is available at [https://flat-breeze-f0a0.templates.workers.dev](https://flat-breeze-f0a0.templates.workers.dev)
